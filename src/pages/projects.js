...
import { Grid, Layout, Project } from "../components";
  ...
  <Layout>
    ...
    <Grid justifyItems="center">
      <Project name="React Bootstrap" maintainer>
        <Project.Summary>
          React Bootstrap is a complete re-implementation of Bootstrap
          components, built with React. This also removes jQuery as a
          dependency.
        </Project.Summary>
        <Project.Contributions>
          ...
          <ul>
            ...
            <li>
              Improved consistency of the API by migrating components to
              properly forward their refs.
            </li>
          </ul>
        </Project.Contributions>
      </Project>
